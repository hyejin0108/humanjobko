from kiosk.utils import *
from kiosk.config import *
from kiosk.message import * 
...
class Kiosk:
    def __init__(self, name:str):
        ...
        self.__input_quantity_msg = input_quantity_msg
        self.__exit_cart_msg = exit_cart_msg
        self.__cancel_cart_msg = cancel_cart_msg
        self.__input_menu_msg = input_menu_msg
        self.__exceed_stock_msg = exceed_stock_msg
        self.__add_cart_msg = add_cart_msg
        self.__complete_order_msg = complete_order_msg
        self.__complete_sale_msg = complete_sale_msg
